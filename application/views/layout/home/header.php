...
<head>
    ...
    <!-- Judul Bagian Pengunjung -->
    <title>Pengunjung | Sarangwayang</title>
                            ...
                            <?php } else { ?>
                                <nav class="main-menu">
                                    <ul>
                                        ...
                                        <li><a href="<?= base_url('welcome/about') ?>">Profil</a></li>
                                        <li><a href="<?= site_url('welcome/product') ?>">Produk</a></li>
                                        <li><a href="<?= base_url('welcome/news') ?>">Wiracarita</a></li>
                                        <li>
                                            <div class="header-icons">
                                                <a class="shopping-cart" href="<?= base_url('login') ?>"><i class="fas fa-user"></i>&nbsp; Daftar atau Masuk</a>
                                            </div>
                                        </li>
                                    </ul>
                                </nav>
