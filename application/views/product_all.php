<!-- Halaman Daftar Produk Pengunjung -->
                ...
                <div class="col-lg-4 col-md-6 text-center strawberry">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="<?= base_url('welcome/detail_product/' . $row->id_brg . '/' . url_title($row->nama_brg)) ?>"><img src="<?= base_url() . '/uploads/' . $row->gambar ?>" alt=""></a>
                        </div>
                        <h3><a href="<?= base_url('welcome/detail_product/' . $row->id_brg . '/' . url_title($row->nama_brg)) ?>" class="text-dark"><?= $row->nama_brg ?></a></h3>
