...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="<?= base_url('assets') ?>/" data-template="vertical-menu-template">
    ...
    <head>
        ...
        <title>Login | Sarangwayang</title>
            ...
            <div class="authentication-inner row">
                ...
                <div class="d-none d-lg-flex col-lg-7 p-0">
                    <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
                        <img src="<?= base_url('assets') ?>/img/illustrations/favicon.png" alt="auth-login-cover" class="img-fluid my-5 auth-illustration" data-app-light-img="illustrations/favicon.png" data-app-dark-img="illustrations/favicon.png" />
                    </div>
                </div>
                <!-- Penutup Logo -->
                ...
                <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
                    <div class="w-px-400 mx-auto">
                        ...
                        <h3 class="mb-1 fw-bold">Halo Sobat Sarangwayang</h3>
                        <p class="mb-4">Silahkan masuk atau mendaftar terlebih dahulu</p>
                        ...
                        <p class="text-center">
                            ...
                            <a href="<?= base_url('register') ?>">
                                <span> Klik Untuk Buat Akun</span>
                            </a>
                        </p>
                    </div>
                </div>
