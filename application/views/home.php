<!-- Halaman Dashboard Pengunjung -->

<!-- Pembuka Tampilan Slider -->
...
<div class="product-section mt-150 mb-150">
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="<?= base_url('welcome/detail_product/' . $p->id_brg . '/' . url_title($p->nama_brg)) ?>"><img src="<?= base_url() . '/uploads/' . $p->gambar ?>" alt=""></a>
                        </div>
                        <h3><?= $p->nama_brg ?></h3>
    ...
    <div class="row">
        <div class="col-lg-12 mt-5 text-center">
            <a href="<?= site_url('welcome/product') ?>" class="boxed-btn">Cari Produk Lainnya</a>
        </div>
    </div>
</div>
...
<div class="latest-news pt-80 pb-100">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 text-center">
                <div class="section-title">
                    <h3><span class="orange-text">CERITA</span> WAYANG</h3>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <a href="<?= site_url('welcome/news') ?>" class="boxed-btn">Baca Cerita Lainnya</a>
            </div>
        </div>
    </div>
</div>
